...
class Datos{
	...
	'tareasColores' => array(
		'creada' 							=> '#FFFFFF', // Blanco
		'planificada' 						=> '#4E65FE', // Azul
		'en_ejecucion' 						=> '#FEDC00', // Amarillo
		'suspendida' 						=> '#DE86EF',  // Suspendida
		'planificada_no_iniciada_atrasada' 	=> '#FF4F67',
		'en_ejecucion_atrasada'				=> '#DF005D',
		'reprogramada'						=> '#FFD86F',
		'replanificada'						=> '#FFFF00'
	),
	...
	'tareasFuentes' => array(
		...
		'en_ejecucion' 						=> '#000000', 
		'suspendida' 						=> '#000000',
		'planificada_no_iniciada_atrasada' 	=> '#000000',
		'en_ejecucion_atrasada'				=> '#FFFFFF',
		'reprogramada'						=> '#000000',
		'replanificada'						=> '#000000'
	),

	'otsColores' => array(
		'creada' 							=> '#FFFFFF', // Blanco
		'con_tareas' 						=> '#4E65FE', // Azul claro
		'ejecucion'							=> '#FEDC00', //Amarillo
		'terminada' 						=> '#C2EF95' // Gris
	),
	...
	'executedtasksEstados' => array(
		'1'	=>	'Iniciada', //(En ejecución y reiniciada)
		'2'	=>	'Suspendida',
		'3'	=>	'Terminada'
	),
	
	'interfacesSap'=>array(
		'Produccion'	=>array('consultaCliente'=>'http://192.168.34.103:8080/XISOAPAdapter/MessageServlet?channel=:PERIFERICO_PDerco:sys_periferico_ConsultaCliente_soap_server&version=3.0&Sender.Service=PERIFERICO_PDerco&Interface=urn:derco-com-pe:piperiferico:dbm:ConsultaClientePlaca&version=3.0&Sender.Service=PERIFERICO_PDERCO&Interface=urn:derco-com-pe:piperiferico:dbm:ConsultaClientePlaca^os_ClienteConsulta',
								'agendamientoCitas'=>'http://192.168.34.103:8080/XISOAPAdapter/MessageServlet?channel=:PERIFERICO_PDerco:sys_periferico_CitaWeb_soap_server&version=3.0&Sender.Service=PERIFERICO_PDerco&Interface=urn:derco-com-pe:piperiferico:dbm:CitaWeb^os_CitaWeb'),
		'Calidad'		=>array('consultaCliente'=>'http://192.168.25.66:51600/XISOAPAdapter/MessageServlet?channel=:PERIFERICO_QDerco:sys_periferico_ConsultaCliente_soap_server&version=3.0&Sender.Service=PERIFERICO_QDerco&Interface=urn:derco-com-pe:piperiferico:dbm:ConsultaClientePlaca&version=3.0&Sender.Service=PERIFERICO_QDERCO&Interface=urn:derco-com-pe:piperiferico:dbm:ConsultaClientePlaca^os_ClienteConsulta',
								'agendamientoCitas'=>'http://192.168.25.66:51600/XISOAPAdapter/MessageServlet?channel=:PERIFERICO_QDerco:sys_periferico_CitaWeb_soap_server&version=3.0&Sender.Service=PERIFERICO_QDerco&Interface=urn:derco-com-pe:piperiferico:dbm:CitaWeb^os_CitaWeb'),
		'Desarrollo'	=>array('consultaCliente'=>'http://xisap-des:50000/XISOAPAdapter/MessageServlet?channel=:PERIFERICO_DDerco:sys_periferico_ConsultaCliente_soap_server&version=3.0&Sender.Service=PERIFERICO_DDerco&Interface=urn:derco-com-pe:piperiferico:dbm:ConsultaClientePlaca&version=3.0&Sender.Service=PERIFERICO_DDERCO&Interface=urn:derco-com-pe:piperiferico:dbm:ConsultaClientePlaca^os_ClienteConsulta',
								'agendamientoCitas'=>'http://xisap-des:50000/XISOAPAdapter/MessageServlet?channel=:PERIFERICO_DDerco:sys_periferico_CitaWeb_soap_server&version=3.0&Sender.Service=PERIFERICO_DDerco&Interface=urn:derco-com-pe:piperiferico:dbm:CitaWeb^os_CitaWeb'),
	),
	
	'interfacesSapIpDns'=>array(
		'Produccion'	=>array(0=>'192.168.34.103',1=>'xi-prd'),
		'Calidad'		=>array(0=>'192.168.25.66',1=>'127.0.0.1'),
		'Desarrollo'	=>array(0=>'192.168.25.24',1=>'xisap-des'),
	),
);
	function getDatos($indice){
