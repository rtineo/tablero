<div class="span-8" >
	...
	<?php echo $this->Html->script('secorganizations/edit.js',false); ?>
	<?php echo $this->Session->flash();?>
	<br/>
	<div id="titulo" class="span-8" >
		<h3><?php echo (__('empresaEditar'));?></h3>
	</div>
	<hr/>
	...
	<?php echo $this->Form->create('Secorganization');?>
		...
		<div class="span-8" >
			<div class="span-3" >
				<label><?php echo (__('C&oacute;digo',true)) ?></label><span class="error"><?php echo " *";?>	</span>
			</div>
		...
		<div class="span-8" >
			...
			<div class="span-5 last" >
				...
				<?php echo $this->Form->select('type', $tipo,array('label'=>'','class'=>'span-5','error'=>false), FALSE); 
		...
		<div class=" span-8 botones" >
			...
			<?php echo $this->Form->button(__('Restablecer',true), array('type'=>'reset')); ?>				
