<div class="programas this->Form">
<?php echo $this->Form->create('Secprogram', array('action' => 'edit'));?>
...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link('Lista De Programas', array('action'=>'listprograms',$this->request->data['Secprogram']['aro_id']));?></li>
	</ul>
</div>
