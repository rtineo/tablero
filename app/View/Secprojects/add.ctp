<div class="span-8" >
<?php echo $this->Html->script('secprojects/add.js',false); ?>
	<?php echo $this->Session->flash();?>
	<br/>
	<div id="titulo" class="span-8" >
		<h3><?php echo (__('ProjectAgregar',true));?></h3>
	...
	<?php echo $this->Form->create('Secproject');?>
		...
		<div class="span-8" >
			...
			<div class="span-5 last" >
				<?php echo $this->Form->select('secorganization_id',$secorganizations,array('class'=>'span-5','label'=>false,'error'=>false,'empty'=>__('seleccionar')));
		...
		<div class="span-8" >
			<div class="span-3" >
				<label><?php echo (__('direccion',true)) ?><span class="error"><?php echo " *";?>	</span>
				</label> 
			</div>
			<div class="span-5 last" >
